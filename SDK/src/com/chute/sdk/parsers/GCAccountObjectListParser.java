...
public class GCAccountObjectListParser implements
		GCHttpResponseParser<GCAccountObjectCollection> {

	@SuppressWarnings("unused")
	private static final String TAG = GCAccountObjectListParser.class
			.getSimpleName();
	...
	@Override
	public GCAccountObjectCollection parse(String responseBody)
