...
public class GCAccountMediaListParser implements
		GCHttpResponseParser<GCAccountMediaCollection> {

	@SuppressWarnings("unused")
	private static final String TAG = GCAccountMediaListParser.class
			.getSimpleName();
	...
	@Override
	public GCAccountMediaCollection parse(String responseBody)
